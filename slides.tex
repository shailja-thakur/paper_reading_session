...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.7, transform shape,
    ...
    \node[above=0.1cm of stepN, font=\tiny] {Step N: The Root Cause};
    ...
    \node[above=0.1cm of stepN1, font=\tiny] {Step N+1: The Cascade};

    \draw[arrow, thick, red, decorate, decoration={snake,amplitude=.4mm,segment length=2mm,post length=1mm}] (stepN) -- node[right, pos=0.5, font=\tiny] {Error Propagates} (stepN1);

    \node[highlight, fit=(memN), inner sep=0.1cm, label={[xshift=-0.7cm, font=\tiny]left:Initial Flaw}] {};
  \end{tikzpicture}
  \end{center}
\end{frame}
