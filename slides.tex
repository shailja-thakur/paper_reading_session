...
\begin{frame}
  ...
  \begin{tikzpicture}[scale=0.85, transform shape,
    stepnode/.style={rectangle, draw, rounded corners, fill=blue!10, minimum width=8cm, minimum height=1.8cm},
    module/.style={rectangle, draw, fill=white, minimum width=2cm, minimum height=1.3cm, text centered, font=\small},
    ...
    \node[above right=0.05cm and -1.5cm of stepN.north east, font=\small] {Step N: The Root Cause};
    ...
    \node[above right=0.05cm and -1.5cm of stepN1.north east, font=\small] {Step N+1: The Cascade};
    ...
    \node[highlight, fit=(memN), inner sep=0.1cm, label={[yshift=0.3cm, font=\small]above:Initial Flaw}] {};
  \end{tikzpicture}
  \end{center}
\end{frame}
