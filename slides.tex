...
\begin{frame}
  ...
  \begin{center}
  \begin{tikzpicture}[
    step/.style={rectangle, draw, rounded corners, fill=blue!10, minimum width=10cm, minimum height=2.5cm},
    ...
    % Step 2
    \node[step, below=1cm of step1] (step2) {};
...
\begin{frame}
  ...
  \begin{tikzpicture}[
    ...
    % Step N+1
    \node[step, fill=red!10, below=1cm of stepN] (stepN1) {};
...
\begin{frame}
  ...
  \begin{center}
    ...
    \caption{Performance of \texttt{AgentDebug} vs. other methods on the ALFWorld benchmark.}
  \end{center}
